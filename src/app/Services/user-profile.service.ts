...
export class UserProfileService {
  ...
  updateMenteeProfile(
    profileData: UpdateMenteeProfile
  ): Observable<UserProfile> {
    return this.http
      .put<UserProfile>(`${this.apiUrl}/mentee`, profileData)
      .pipe(catchError(this.handleError));
  }

  updateMentorProfile(
    profileData: UpdateMentorProfile
  ): Observable<UserProfile> {
    return this.http
      .put<UserProfile>(`${this.apiUrl}/mentor`, profileData)
      .pipe(catchError(this.handleError));
  }
  ...
  updateProfilePictureByUrl(profilePictureUrl: string): Observable<any> {
    return this.http
      .post(
        `${this.apiUrl}/update-photo-by-url`,
  ...
  uploadProfilePictureFile(file: File): Observable<string> {
    ...
    return this.http
      .post(`${this.apiUrl}/upload-photo`, formData, {
        responseType: 'text',
      })
      .pipe(catchError(this.handleError));
  }
  ...
  toggleMentorInterviewerStatus(isInterviewer: boolean): Observable<any> {
    let params = new HttpParams().set(
      'isInterviewer',
      isInterviewer.toString()
    );
    return this.http
      .put(`${this.apiUrl}/toggle-mentor-interviewer-status`, null, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  updateMentorHourlyRate(hourlyRate: number): Observable<any> {
    ...
    return this.http
      .put(`${this.apiUrl}/hourly-rate`, null, { params })
      .pipe(catchError(this.handleError));
  }

  getMentorPublicProfile(mentorId: number): Observable<Mentor> {
    return this.http
      .get<Mentor>(`${this.apiUrl}/mentors/${mentorId}`)
      .pipe(catchError(this.handleError));
  }
