...
@Component({
  ...
  styleUrl: './mentee-profile.component.css'
})
...
userProfile: UserProfile | null = null;
  ...
  initForms(): void {
    this.profileForm = this.fb.group({
      ...
      // Mentee does not have hourlyRate or isInterviewer
    });
  ...
  loadUserProfile(): void {
    ...
    this.userProfileService.getUserProfile().pipe(
      ...
      if (profile.role !== 'Mentee') {
        this.errorMessage = 'Access Denied: Not a Mentee profile.';
        this.isLoading = false;
        return;
      }
  ...
  updateProfile(): void {
    ...
    this.userProfileService.updateMenteeProfile(updateData).pipe(
      catchError(error => {
